...
const writeups = defineCollection({
  ...
  schema: z.object({
    ...
    category:     z.enum(['Blue Team', 'Forensics', 'CTF', 'Threat Hunting', 'OSINT', 'Web', 'Crypto', 'Incident Response / DFIR', 'Digital Forensics / Malware Analysis', 'Network Forensics / PCAP Analysis / SOC Analysis', "Incident Response / SOC Analysis", 'Digital Forensics / Incident Response', "Threat Hunting / Incident Response"]),
